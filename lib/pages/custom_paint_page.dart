...
class CustomPaintPage extends StatefulWidget {
  const CustomPaintPage({Key key, this.title}) : super(key: key);
              ...
              children: <Widget>[
                ...
                Positioned(
                  top: 130,
                    left: 110,
                    child: Transform(
                      transform: new Matrix4.skew(-0.3,0.3),
                      child: Container(
                  width: 100,
                  height: 100,
//                  color: Colors.yellow,
                        child: Column(
                          children: <Widget>[
                            Text('得分',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18),),
                            Text('100分',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18),),
                          ],
                        ),
                ),
                    ))
...
class DashPathPainter extends CustomPainter {
  final Path p = Path()
    ..moveTo(10.0, 10.0)
//    ..lineTo(100.0, 100.0)
    ..addOval(Rect.fromLTWH(100.0, 120.0, 100.0, 100.0));
...
//    ..addRect(Rect.fromLTWH(0.0, 0.0, 50.0, 50.0));
  ...
  @override
  void paint(Canvas canvas, Size size) {
    canvas.drawCircle(Offset(150, 170), 60, black);
    canvas.drawPath(
        dashPath(
          p,
